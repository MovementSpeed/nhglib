 ...
 */
public class PBRShader2 extends BaseShader {
    ...
    public PBRShader2(Renderable renderable, Environment environment, Params params) {
        ...
        String frag = prefix + Gdx.files.internal("shaders/tf_pbr_shader2.frag").readString();
