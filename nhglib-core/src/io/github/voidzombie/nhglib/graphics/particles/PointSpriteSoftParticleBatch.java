 ...
 * @author Inferno
 */
public class PointSpriteSoftParticleBatch extends BufferedParticleBatch<PointSpriteControllerRenderData> {
    ...
    public PointSpriteSoftParticleBatch(RenderingSystem renderingSystem) {
        this(renderingSystem, 1000);
    }

    public PointSpriteSoftParticleBatch(RenderingSystem renderingSystem, int capacity) {
        this(renderingSystem, capacity, new ParticleShader.Config(ParticleShader.ParticleType.Point));
    }

    public PointSpriteSoftParticleBatch(RenderingSystem renderingSystem, int capacity, ParticleShader.Config shaderConfig) {
        ...
        ParticleShader particleShader = new ParticleShader(renderable, shaderConfig);
